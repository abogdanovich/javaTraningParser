...
public class ClassGenerator extends CommonParseActions {
    private static final Logger log = Logger.getLogger(ClassGenerator.class);
     ...
     * @throws IOException
     */
    private void generateActionClass(String actionName, ArrayList<String> params) throws Exception {

...
public class XmlGenerator extends CommonParseActions {
     ...
     * @throws Exception
     */
    public void generateJSystemWorkflow(String filePath, String fileName, ArrayList<ArrayList<String>> actionsWithUUID, boolean scenarioWithActions, String testCase, ArrayList<String> loopData) throws Exception {
        // xml file header
